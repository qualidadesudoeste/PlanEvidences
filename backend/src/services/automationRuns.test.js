...
test('isola o lote por usuário e contabiliza resultados por cenário', () => {
  ...
  claimAutomationRun(internal, { name: 'Runner', version: '0.2.2', machine: 'QA-PC' });
